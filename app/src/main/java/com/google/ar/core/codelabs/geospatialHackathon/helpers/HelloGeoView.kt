 ...
 */
package com.google.ar.core.codelabs.geospatialHackathon.helpers
...
import com.google.ar.core.codelabs.geospatialHackathon.HelloGeoActivity
import com.google.ar.core.codelabs.geospatialHackathon.R
...
class HelloGeoView(val activity: HelloGeoActivity) : DefaultLifecycleObserver {
  ...
  fun updateStatusText(earth: Earth, cameraGeospatialPose: GeospatialPose?) {
    activity.runOnUiThread {
      ...
      statusText.text = activity.resources.getString(R.string.site_title,
