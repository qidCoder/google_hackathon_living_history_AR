    ...
    try {
      ...
      virtualObjectTexture =
        Texture.createFromAsset(
          render,
          "models/soldier_baked.png",
          Texture.WrapMode.REPEAT,
          Texture.ColorFormat.SRGB
        )

      virtualObjectMesh = Mesh.createFromAsset(render, "models/soldier.obj");
      virtualObjectShader =
...
//        longitude = cameraGeospatialPose.longitude,
        latitude = 42.3587627,
        longitude = -71.0572023,//currently hardcoded to boston massacre site
